...
import { PLUGIN_ID, VIEWS_IDS, INTERACTIONS } from "../../constants";
import { NavigationBar } from "../common/NavigationBar";
import { bindings } from "../schema";

const pubPayload = JSON.stringify({
  pluginID: PLUGIN_ID,
  viewID: VIEWS_IDS.CONSOLE,
  payload: bindings.expression,
});

const evaluateExpression = e`publish(${INTERACTIONS.EVALUATE_EXPRESSION}, ${pubPayload})`;
